...
export default function StatsSection() {
  const stats = [
    { icon: Users, value: '50+', label: 'Interns Onboarded', color: 'from-blue-500 to-cyan-500' },
    { icon: Briefcase, value: '10+', label: 'Departments', color: 'from-purple-500 to-pink-500' },
    { icon: Award, value: '100%', label: 'Projects Delivered', color: 'from-orange-500 to-red-500' },
    { icon: TrendingUp, value: '95%', label: 'Happy Interns', color: 'from-green-500 to-emerald-500' }
  ];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mt-16 text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-lg px-6 py-3 rounded-full border border-white/20">
            ...
            <span className="font-semibold">4.8/5 average rating from interns</span>
          </div>
        </motion.div>
      </div>
    </section>

...
const Certificate = ({
  ...
  return (
    <div className="relative max-w-3xl mx-auto bg-gradient-to-r from-purple-100 via-pink-50 to-indigo-50 border-4 border-blue-500 rounded-2xl p-12 shadow-xl overflow-hidden mt-10">
      ...
      <p className="text-center text-lg text-gray-800 mb-6">
        has successfully completed the <span className="font-semibold">{internship}</span> <br />
      ...
      <p className="text-center text-base text-gray-700 mb-10 max-w-2xl mx-auto">
        This certificate recognizes dedication, hard work, and outstanding performance during the internship. The recipient demonstrated practical skills, professionalism, and commitment, contributing to projects and learning outcomes with excellence.
      </p>

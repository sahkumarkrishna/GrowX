...
export default function WhyChooseUs() {
  const reasons = [
    { icon: Star, title: 'Professional Templates', desc: 'Designed by HR experts and recruiters from top companies', stats: '10+ Premium Templates' },
    { icon: Zap, title: 'Quick & Easy', desc: 'Build your resume in minutes with our intuitive editor', stats: '5 Minutes Average Time' },
    { icon: CheckCircle, title: 'ATS-Optimized', desc: 'Pass Applicant Tracking Systems and reach recruiters', stats: '95% ATS Pass Rate' },
    { icon: Shield, title: 'Secure & Private', desc: 'Your data is encrypted and never shared with third parties', stats: '100% Data Privacy' }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">
            Why Choose <span className="text-blue-600">GrowX Resume Builder</span>?
          </h2>
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-gray-900 text-white rounded-3xl p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 grid md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <div className="text-lg">Forever Plan</div>
            </div>
            <div>
            ...
            <div>
              <div className="text-5xl font-bold mb-2 text-blue-400">Instant</div>
              <div className="text-lg">PDF Download</div>
            </div>
          </div>
        </motion.div>
      </div>

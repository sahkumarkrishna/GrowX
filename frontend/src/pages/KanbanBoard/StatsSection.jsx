    ...
    <section className="py-20 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-white/80 text-lg">Real results from real users</p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, i) => (
            <motion.div
              ...
              className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 text-center shadow-xl hover:shadow-2xl transition-all"
            >
